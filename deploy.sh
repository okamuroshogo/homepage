...
push_ecr_image(){
    ...
    docker tag $AWS_ACCOUNT_ID.dkr.ecr.ap-northeast-1.amazonaws.com/${AWS_ECR_REP_NAME}:$CIRCLE_SHA1 aws/okamu.ro/homepage:latest 943556878241.dkr.ecr.ap-northeast-1.amazonaws.com/aws/okamu.ro/homepage:latest
#	docker push $AWS_ACCOUNT_ID.dkr.ecr.ap-northeast-1.amazonaws.com/${AWS_ECR_REP_NAME}:$CIRCLE_SHA1
    docker push aws/okamu.ro/homepage:latest 943556878241.dkr.ecr.ap-northeast-1.amazonaws.com/aws/okamu.ro/homepage:latest
}
